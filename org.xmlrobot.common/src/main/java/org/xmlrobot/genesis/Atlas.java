...
public interface Atlas
    ...
    // Views
    /**
     * Returns a {@link Congregation} view of the keys contained in this atlas.
     ...
     * operations.
     *
     * @return a congregation view of the keys contained in this atlas
     */
    Congregation<K> keySet();

    /**
     * Returns a {@link Congregation} view of the values contained in this atlas.
     * The collection is backed by the atlas, so changes to the atlas are
     * reflected in the collection, and vice-versa.  If the atlas is
     ...
     *
     * @return a congregation view of the values contained in this atlas
     */
