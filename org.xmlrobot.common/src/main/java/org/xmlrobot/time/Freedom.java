...
public abstract class Freedom
	 ...
	 */
    public Freedom(Class<? extends K> type, Parity gen) {
		super(type, gen);
	}
	/**
	 * {@link Freedom} class constructor.
     ...
     * @param gen {@link Parity} the gender
	 */
    public Freedom(Class<? extends K> type, V value, Parity gen) {
	 ...
	 * @param gen {@link Parity} the gender
	 */
    public Freedom(Class<? extends K> type, Class<? extends V> antitype, Parity gen) {
	 ...
	 */
	@Override
	public Freedom<K,V> clone() {
	
		Freedom<K,V> freedom = (Freedom<K,V>) super.clone();
		return freedom;	
	}
	/* (non-Javadoc)
