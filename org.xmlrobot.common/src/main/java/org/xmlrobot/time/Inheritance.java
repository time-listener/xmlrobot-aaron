...
import org.xmlrobot.util.PastIterator;
...
public abstract class Inheritance
	 ...
	 */
	public Inheritance(Class<? extends K> type, K parent) {
	 ...
	 */
	public Inheritance(Class<? extends K> type, V value, K parent) {
     ...
     * @param gen {@link Parity} the gender
	 */
	public Inheritance(Class<? extends K> type, V value, Parity gen) {
     ...
     * @param parent the parent of inheritance
	 */
	public Inheritance(Class<? extends K> type, Class<? extends V> antitype, K parent) {
	 ...
	 * @param gen {@link Parity} the gender
	 */
	public Inheritance(Class<? extends K> type, Class<? extends V> antitype, Parity gen) {
	...
	/* (non-Javadoc)
	 * @see org.xmlrobot.hyperspace.Hyperspace#start(org.osgi.framework.BundleContext)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.xmlrobot.hyperspace.Hyperspace#stop(org.osgi.framework.BundleContext)
	 */
	@Override
