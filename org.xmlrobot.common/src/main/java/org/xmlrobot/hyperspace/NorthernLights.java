...
public abstract class NorthernLights
	 ...
	 */
    public NorthernLights(Class<? extends K> type, Parity gen) {
		super(type, gen);
	}
	/**
	 * {@link NorthernLights} class constructor.
     ...
     * @param gen {@link Parity} the gender
	 */
    public NorthernLights(Class<? extends K> type, V value, Parity gen) {
	 ...
	 * @param gen {@link Parity} the gender
	 */
    public NorthernLights(Class<? extends K> type, Class<? extends V> antitype, Parity gen) {
		super(type, antitype, gen);
	}
	
	/* (non-Javadoc)
	 * @see org.xmlrobot.hyperspace.Language#clone()
	 */
	@Override
	public NorthernLights<K,V> clone() {
	
		return (NorthernLights<K,V>) super.clone();
	}
	/**
