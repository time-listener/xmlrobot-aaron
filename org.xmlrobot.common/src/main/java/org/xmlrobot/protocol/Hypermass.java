...
public class Hypermass<K,V> 
	 ...
	 * The inherited mass
	 */
	Hyperbody<Mass<K,V>,Mass<V,K>> body;
	...
	public K getKey() {
		...
		return body.getAndCast(Mass.KEY);
	}
	/* (non-Javadoc)
	...
	public K setKey(K key) {
		...
		return body.getAndSet(Mass.KEY, key);
	}
	/* (non-Javadoc)
	...
	public V getValue() {
		...
		return body.getAndCast(Mass.VALUE);
	}
	/* (non-Javadoc)
	...
	public V setValue(V value) {
		...
		return body.getAndSet(Mass.VALUE, value);
	}
	/**
