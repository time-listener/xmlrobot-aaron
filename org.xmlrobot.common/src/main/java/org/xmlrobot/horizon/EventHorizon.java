...
public abstract class EventHorizon
	 ...
	 */
	@Override
	public <U> Phaser<U> submit(Callable<U> task) {
	...
	public K setChild(K listener) {
		...
		return getSource().setChild(listener);
	}
	/* (non-Javadoc)
